  ...
  return (
    ...
    >
      ...
      <div className="md:w-[50%] flex flex-col gap-5">
        <h1 className="text-2xl font-semibold">Bible Quiz</h1>
        <p className="text-sm leading-6 text-gray-300">
          Unlock the treasures of the Bible and test your knowledge with our challenging quiz. 
	  Dive deep into the timeless stories, profound teachings, and inspiring messages found 
	  within the sacred scriptures. Whether you're a devout believer or simply curious about 
	  biblical history, this quiz is designed to engage, educate, and entertain.
        </p>
        <Link
